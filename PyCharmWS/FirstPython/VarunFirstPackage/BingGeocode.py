...
payload = {'addressLine':'','CountryRegion':'','key':'Ai6_ZWj1QMq6jokfNscwW6HqBnkDSvdbRLTe2mwv5whK8LwaduNxUbpCBlbtOYjb'}

inputFile = "D:/GeocodingProjects/Vietnam_VNM/16Sept_Runs/csv/VNM_Real_BulkTester_Comparison_BM.txt"
outputFile = "D:/GeocodingProjects/Vietnam_VNM/16Sept_Runs/csv/BingGeocodeOutput_Test.txt"
outputHeader = "Address|B_Latitude|B_Longitude|B_Locality|B_Street|B_District|G_State"
...
def bingGeocode(fullAddress):
    payload['addressLine'] = fullAddress
    payload['CountryRegion'] =countryCode
...
def bulkGeocode(fullAddressList):
    ...
    for address in fullAddressList:
        geocodedOutput= bingGeocode(address)
